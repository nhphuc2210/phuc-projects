 ...
 */
function runFromUI() {
  // const SHEET_URL = 'https://docs.google.com/spreadsheets/d/1qHRqfQx5CkJ7WqXfCyIHRrA-7M-gwNAAuGB8BDuhOGI/';
  // const PROJECT_ID = 'cloud-service-322312';
  // const DATASET_ID = 'my_schema';
  // const TABLE_ID = 'cpas_hitlist';
  // const APPEND = 'TRUE';
  // const STATUS = 5;
  ...
  let sheet = SpreadsheetApp.getActive().getSheetByName('fromUI');
...
function openSheetByUrl(sheetUrl) {
  ...
  let sheet = spreadsheet.getSheetByName('get_data')
  if (!sheet)
